	...
	implements Serializable
{
	...
	@Getter int height;
	@Getter int width;
	@Getter CubeShape nextShape;
	/**
	 * 合成后的
	 */
	@Getter CubeInfo[][] cubeMatrix;
	/**
	 * 基本的,不包括正在运动的
	 */
	 ...
	 * 游戏玩家
	 */
	@Getter List<GamePlayer> players;
	@Getter @Setter transient GameAreaEventListener eventListener;
	@Getter boolean gameOver = false;
